  ...
  return (
    <React.Fragment>
      <Paper className={classes.root} elevation={1}>
        ...
        <Typography component="p" variant="body2" style={{ marginTop: "10px" }}>
          ...
          "input" all other factors are considered constant. Asymptotic analysis
        ...
        <Typography component="p" variant="body2">
          ...
          x not being present in array). So we sum all the cases and divide the
        ...
        <Typography component="p" variant="body2">
          ...
          occurs when x is present at the first location. The number of
        ...
        <Typography component="p" variant="body2">
          ...
          defines exact asymptotic behavior. A simple way to get Theta notation
          of an expression is to drop low order terms and ignore leading
        ...
        <Typography component="p" variant="body2">
          ...
          c1*g(n) and c2*g(n) for large values of n (n >= n0). The definition of
          theta also requires that f(n) must be non-negative for values of n
          greater than n0.
        </Typography>
        ...
        <Typography component="p" variant="body2">
          The Big O notation defines an upper bound of an algorithm, it bounds a
          function only from above. For example, consider the case of Insertion
          Sort. It takes linear time in best case and quadratic time in worst
          case. We can safely say that the time complexity of Insertion sort is
          O(n
          <sup>2</sup>
          ). Note that O(n
        ...
        <Typography component="p" variant="body2">
          ...
          useful when we have lower bound on time complexity of an algorithm.The
        ...
        {props.containerWidth > 1000 ? <Table rows={rows} /> : null}

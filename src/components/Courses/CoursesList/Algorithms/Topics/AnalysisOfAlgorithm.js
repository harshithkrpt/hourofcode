...
class AnalysisOfAlgrithm extends Component {
  render() {
        ...
        <React.Fragment>
          <Paper className={classes.root} elevation={1}>
            ...
            >
              ...
              the algorithm, it is concluded to work in a constant time. Other
              than the "input" all other factors are considered constant.
            ...
            <Typography component="p" variant="body2">
              In the worst case analysis, we calculate upper bound on running
              time of an algorithm. We must know the case that causes maximum
              number of operations to be executed. For Linear Search, the worst
              case happens when the element to be searched (x in the above code)
              is not present in the array. When x is not present, the search()
              functions compares it with all the elements of arr[] one by one.
              Therefore, the worst case time complexity of linear search would
              be Θ(n).
            </Typography>
            ...
            <Typography component="p" variant="body2">
              ...
              calculated values and divide the sum by total number of inputs. We
              must know (or predict) distribution of cases. For the linear
            ...
            <Typography component="p" variant="body2">
              ...
              time of an algorithm. We must know the case that causes minimum
              ...
              number of operations in the best case is constant (not dependent
            ...
            <Typography component="p" variant="body2">
              ...
              c1*g(n) and c2*g(n) for large values of n (n >= n0). The
              definition of theta also requires that f(n) must be non-negative
            ...
            <Typography component="p" variant="body2">
              ...
              bounds a function only from above. For example, consider the case
              of Insertion Sort. It takes linear time in best case and quadratic
            ...
            <Typography component="p" variant="body2">
              The Big O notation is useful when we only have upper bound on time
              complexity of an algorithm. Many times we easily find an upper
              bound by simply looking at the algorithm. lower bound. Ω Notation
              can be useful when we have lower bound on time complexity of an
              algorithm.The best case performance of an algorithm is generally
              not useful, the Omega notation is the least used notation among
              all three.
            </Typography>
            <Typography component="p" variant="body2">
            ...
            {this.props.containerWidth > 1000 ? <Table rows={rows} /> : null}
...
export default withStyles(styles)(Dimensions()(AnalysisOfAlgrithm));

...
export const Example3Output = <pre>7 8 4 6 3 1 2 5</pre>;

export const Example2Output = (
  <pre>
    Following are k randomly selected items <br />6 2 11 8 12 <br />
    Note: Output will differ every time as it selects and prints random elements
  </pre>
);
export const Example1Output = (
  <pre>
    Contracting edge 0-2 <br />
    Contracting edge 0-3 <br />
